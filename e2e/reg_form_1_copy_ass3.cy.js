    ...
    it('User cannot submit data when password and/or confirmation password is absent', () => {
        ...
        // Assert that submit button is not enabled and that successful message is not visible
           ...
           // cy.get('input[type="password"]').scrollIntoView()
            ...
            // Assert that correct error message is visible and contain Mandatory input field...incorrect code, impossible to produce
            //cy.get('#input_error_message').should('be.visible').should('contain', 'Mandatory input field is not valid or empty!')
            // cy.get('#input_error_message').should('be.visible').should('contain', 'Mandatory input field');
